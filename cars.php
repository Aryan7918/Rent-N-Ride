        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card card-body">
                    <div class="row">
                        <!-- <div class="col-md-4">
                            <label class="title-sm fs-12" for="car_city">Select City</label> <br>
                            <input list="list" class="form-control" name="car_city" id="car_city">
                            <datalist id="list" name="car_city">
